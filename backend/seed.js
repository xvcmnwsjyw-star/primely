...
// Populates subjects, a demo admin/instructor/student, a couple of
// published courses (one with a real quiz), and a demo coupon.
...
const run = async () => {
  ...
  console.log("Seeded 8 subjects, 3 demo users, 8 courses, 1 coupon.");
